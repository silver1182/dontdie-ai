        ...
        skills: [
            {
                ...
                icon: '🎮',
                title: '2048 AI 助手',
                desc: '输入任意棋盘局面，AI 立即分析并给出最优移动方向。支持手动设置、AI提示、自动演示三种模式。纯前端实现，双击即用！',
                features: ['任意局面设置（不只是从2开始）', 'AI 智能提示最优方向', '自动演示模式（看AI表演）', '纯前端无需联网'],
                price: '¥6',
                active: true
            },
            {
                ...
                icon: '🕷️',
                title: '竞品数据抓取',
                desc: '自动化抓取电商平台数据，生成竞品分析报告。适合电商运营、市场分析。',
